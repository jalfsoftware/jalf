...
public class AbstractProjectileEntity extends AbstractEntity/* implements Poolable*/ {
	...
	public AbstractProjectileEntity(float xPos, float yPos, Texture texture, GameScreen gameScreen, float maxSpeed, Direction lastXDirection, float entityHeight) {
	...
	public void render(Batch batch) {
		if (lastXDirection == Direction.LEFT)
			xPos = xPos - maxSpeed * delta;
		else
			xPos = xPos + maxSpeed * delta;
